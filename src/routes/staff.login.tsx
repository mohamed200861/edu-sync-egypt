...
export const Route = createFileRoute("/staff/login")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "بوابة تسجيل دخول المشرفين والسكرتارية والمعلمين.",
      },
    ],
  }),
...
function StaffLoginPage() {
  ...
  const signIn = async (e: React.FormEvent) => {
    ...
    // Client-side isolation: student emails cannot use the staff portal.
    ...
    // Server-side isolation: verify the user actually holds a staff role.
